    ...
    public class CatalogoContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Articulo>().HasData(
                ...
                new Articulo { Id = 2, Codigo = "M03", Nombre = "Moto G Play 7ma Gen", Descripcion = "Ya siete de estos?", MarcaId = 5, CategoriaId = 1, ImagenUrl = "https://i.blogs.es/baafde/motorola-moto-g7/1366_2000.webp", Precio = 15699 },
                new Articulo { Id = 3, Codigo = "S99", Nombre = "Play 4", Descripcion = "Ya no se cuantas versiones hay", MarcaId = 3, CategoriaId = 3, ImagenUrl = "https://images.fravega.com/f1000/b88b497b0887aa2110d09fe389a29054.jpg", Precio = 35000 },
                new Articulo { Id = 4, Codigo = "S56", Nombre = "Bravia 55", Descripcion = "Alta tele", MarcaId = 3, CategoriaId = 2, ImagenUrl = "https://fulltec.com.bo/medios/2021/08/KD-55X725E-4.jpg", Precio = 49500 },
                new Articulo { Id = 5, Codigo = "A23", Nombre = "Apple TV", Descripcion = "lindo loro", MarcaId = 2, CategoriaId = 3, ImagenUrl = "https://www.apple.com/newsroom/images/2023/12/redesigned-apple-tv-app-simplifies-the-viewing-experience/article/Apple-TV-app-home-screen_big.jpg.large_2x.jpg", Precio = 7850 },
              ...
              new Articulo { Id = 7, Codigo = "S20", Nombre = "Samsung QLED 65", Descripcion = "Televisor de alta definición", MarcaId = 1, CategoriaId = 2, ImagenUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ9iqqSfTfIlR4odS9nlUOxO8wH1lu98ceyvA&s", Precio = 120000 },
                ...
                new Articulo { Id = 9, Codigo = "M10", Nombre = "Moto E20", Descripcion = "Celular económico", MarcaId = 5, CategoriaId = 1, ImagenUrl = "https://ar.celulares.com/fotos/motorola-moto-e20-94506-g.jpg", Precio = 10999 },
                new Articulo { Id = 10, Codigo = "S77", Nombre = "Sony WH-1000XM4", Descripcion = "Auriculares con cancelación de ruido", MarcaId = 3, CategoriaId = 4, ImagenUrl = "https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcRwSPDvpeUVbL_SSTHEnUu9Wblp5hGqrjpY9gRjUplzy--_EbtfWpYKKi78wXxnCPR-bSBYx_gRI4LkRsCeyNNSpwpfbRPKNl0upmwAgdCX8wQzWJBkilJt2ID1c91RsijIkWngOk0&usqp=CAc", Precio = 29999 },
                new Articulo { Id = 11, Codigo = "A99", Nombre = "Apple iPad Pro", Descripcion = "Tablet de alto rendimiento", MarcaId = 2, CategoriaId = 3, ImagenUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0roqcdNDvARcExaG2lSjzefvfrittrcbpbw&s", Precio = 150000 },
                new Articulo { Id = 12, Codigo = "H55", Nombre = "Huawei MateBook", Descripcion = "Notebook ligera", MarcaId = 4, CategoriaId = 3, ImagenUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSilXc9Z-LL-TY3amhFEDmSbRGHMQx030hskg&s", Precio = 95000 },
