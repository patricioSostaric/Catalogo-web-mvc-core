...
namespace CatalogoWeb.Tests.Services
{
    public class IpAnonimizadorTests
    {
        ...
        [Theory]
        [InlineData("186.13.114.8", "186.13.114.0")]
        ...
        public void Anonimizar_IPv4_ConservaLaRed()
        {
            ...
            var primero = IpAnonimizador.Anonimizar(IPAddress.Parse("186.13.114.8"));
            var segundo = IpAnonimizador.Anonimizar(IPAddress.Parse("186.13.114.240"));
        ...
        [InlineData("::ffff:186.13.114.8", "186.13.114.0")]
        ...
        [Theory]
        [InlineData("186.13.114.8")]
        [InlineData("::ffff:186.13.114.8")]
